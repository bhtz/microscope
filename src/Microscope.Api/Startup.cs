...
using Microscope.Admin.Api.Configuration.Authorization;
using Microscope.Admin.Api.ExceptionHandling;
using Microscope.Admin.Api.Helpers;
using Microscope.Admin.Api.Mappers;
using Microscope.Admin.Api.Resources;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
using Microscope.Admin.EntityFramework.Shared.DbContexts;
using Microscope.Admin.EntityFramework.Shared.Entities.Identity;

namespace Microscope.Admin.Api
{
