...
using Microscope.Admin.Api.AuditLogging;
using Microscope.Admin.Api.Configuration;
using Microscope.Admin.Api.Configuration.ApplicationParts;
using Microscope.Admin.Api.Configuration.Constants;
using Microscope.Admin.Api.Helpers.Localization;
...
namespace Microscope.Admin.Api.Helpers
{
