...
using Microscope.STS.Identity.Configuration.ApplicationParts;
using Microscope.STS.Identity.Configuration.Constants;
using Microscope.STS.Identity.Configuration.Interfaces;
using Microscope.STS.Identity.Helpers.Localization;
using Microscope.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Microscope.Admin.EntityFramework.MySql.Extensions;
using Microscope.Admin.EntityFramework.PostgreSQL.Extensions;
using Microscope.Admin.EntityFramework.Shared.Configuration;
using Microscope.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace Microscope.STS.Identity.Helpers
{
