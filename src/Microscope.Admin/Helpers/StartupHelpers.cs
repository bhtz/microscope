...
using Microscope.Admin.Configuration;
using Microscope.Admin.Configuration.ApplicationParts;
...
using Microscope.Admin.Helpers.Localization;
using System.Linq;
...
namespace Microscope.Admin.Helpers
{
